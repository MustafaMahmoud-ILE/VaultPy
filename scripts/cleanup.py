...
if __name__ == "__main__":
    ...
    if os.path.exists(dist_path):
        print("Build detected. Zipping VaultPy_v1.2.3.zip for distribution...")
        try:
            shutil.make_archive(os.path.join(project_root, 'VaultPy_v1.2.3'), 'zip', dist_path)
            print("  Created: VaultPy_v1.2.3.zip")
        except Exception as e:
